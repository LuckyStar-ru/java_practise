...
/*
    public static void main(String[] args) {
        ...
        System.out.println(s1.getRadius()); // None, Shape doesn't have this method
        ...
        System.out.println(s4.getSide()); // Shape doesn't have this method
        ...
        System.out.println(r2.getSide()); // It's Square method, no Rectangle
